...
function setDayGridStyle(element, dayNumber, target, participantsRemaining) {
...
function setNightGridStyle(element, nightNumber, target, participantsRemaining) {
    ...
    try {
        ...
        for (var i = 0; i < nightsIDs.length - 1; i++) {
            ...
            if (deathOnNightOrDay == 1) {
                var result = getRandomNumber(participantsCopy.length - 1);
            }
